...
const NoteForm = () => {
    ...
    <div className="mb-4">
        ...
        <input type="text" className="w-full p-2 border rounded-lg" value={title} 
        onChange={(e) => setTitle(e.target.value)}>
        </input>
        </div>
    <div className="mb-4">
        <label htmlFor="priority" className="block font-semibold">Priority</label>
        <select type="text" className="w-full p-2 border rounded-lg" value={priority} 
    ...
    <div className="mb-4">
        ...
        <select type="text" className="w-full p-2 border rounded-lg" value={category} 
    ...
    <div className="mb-4">
        ...
        <textarea type="text" className="w-full p-2 border rounded-lg" value={description} 
